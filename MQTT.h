...
#define HOTSPOT_WIFI  "IOT_RULES"            /* Nombre del punto de acceso a conectarse */
...
#define TXTOPIC       "/SEIoT/TX_TEST/ALEX_6_C"         /* Nombre del topic de publicación */
#define RXTOPIC       "/SEIoT/RX_TEST/ALEX_6_C"         /* Nombre del topic de suscripción */
...
class MQTT {
  ...
  public:
    ...
    void publish_MQTT ( String JSON_FINAL );              /* Conecta al usuario como un pulicador MQTT */
...
void MQTT :: publish_MQTT ( String JSON_FINAL ) {

  Serial.println ( F ( "Publicando información" ) );
  client.publish( TXTOPIC, JSON_FINAL.c_str() );                 /* Función librería PubsubClient */
